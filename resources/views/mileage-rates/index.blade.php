                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="editable-rate" 
                                                  data-year="{{ $rate->year }}" 
                                                  data-rate="{{ $rate->rate_cents_per_mile }}">
                                                {{ $rate->rate_cents_per_mile }}¢
                                            </span>
                                        </td>
                                        <td>${{ number_format($rate->rate_in_dollars, 2) }}</td>
                                        <td class="text-end">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('save-rate-btn').addEventListener('click', function() {
        ...
        fetch('{{ route("mileage-rates.update") }}', {
            method: 'POST',
            body: formData,
            headers: {
